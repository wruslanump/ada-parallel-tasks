pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__main_ada_parallel_tasks.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__main_ada_parallel_tasks.adb");
...
package body ada_main is
   ...
   E204 : Short_Integer; pragma Import (Ada, E204, "pkg_ada_task_level1_E");
   ...
   begin
      ...
      E168 := E168 + 1;
      pkg_ada_task_level1'elab_body;
      E204 := E204 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_main_ada_parallel_tasks");
...
--  BEGIN Object file/option list
   --   /home/wruslan/github-ump/ada-parallel-tasks/obj/pkg_ada_dtstamp.o
   --   /home/wruslan/github-ump/ada-parallel-tasks/obj/pkg_ada_task_level1.o
   --   /home/wruslan/github-ump/ada-parallel-tasks/obj/main_ada_parallel_tasks.o
   --   -L/home/wruslan/github-ump/ada-parallel-tasks/obj/
   --   -L/home/wruslan/github-ump/ada-parallel-tasks/obj/
